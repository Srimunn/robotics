 ...
 *
 * CEO and RS (subRole === "RS" or no subRole set for legacy Supervisor/CEO) have full edit permissions.
...
export function canEdit(currentUser: CurrentUser | null | undefined): boolean {
  ...
  if (currentUser.role === "Worker") {
    ...
    // RS or legacy manager/supervisor without subRole
    return true;
  }
  return false;
}
 ...
 * All management roles (CEO, RS, CS, and BS) have enquiry create and field editing rights.
 */
 ...
 * Strictly restricted to CEO and RS. CS and BS CANNOT convert enquiries.
 */
