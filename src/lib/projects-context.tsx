...
const seedProjects: Project[] = [
  {
    ...
    location: "Chennai",
    natureOfWork: "Interior Painting",
    projectValue: 250000,
  ...
  },
  {
    ...
    location: "Hyderabad",
    natureOfWork: "Roof Waterproofing",
    projectValue: 175000,
    paymentReceived: 0,
    createdAt: new Date().toISOString(),
  },
  {
    ...
    location: "Coimbatore",
    natureOfWork: "Kitchen Renovation",
    projectValue: 620000,
    paymentReceived: 620000,
    createdAt: new Date().toISOString(),
  },
  {
    id: uid(),
  ...
  },
  {
    ...
    location: "Vizag",
    natureOfWork: "Structural Repair",
    projectValue: 890000,
...
const seedOngoing: OngoingWork[] = [
  {
    ...
    natureOfWork: "Foundation Work",
    labourCount: 12,
    labourType: "Masons + Helpers",
    remarks: "Slab pouring scheduled Friday",
    createdAt: new Date().toISOString(),
  },
  {
    id: uid(),
    ...
    natureOfWork: "Electrical Wiring",
    labourCount: 6,
    labourType: "Electricians",
  ...
  },
  {
    ...
    contactNumber: "9765001122",
    location: "Hyderabad - Kondapur",
    natureOfWork: "Plastering",
    labourCount: 8,
    labourType: "Skilled Masons",
    remarks: "Client approved finish",
    createdAt: new Date().toISOString(),
  },
];
...
export function ProjectsProvider({ children }: { children: ReactNode }) {
  ...
  const value: Ctx = {
    ...
    ongoing,
    addProject: (p) =>
      setProjects((prev) => [{ ...p, id: uid(), createdAt: new Date().toISOString() }, ...prev]),
    updateProject: (id, p) =>
    ...
    addOngoing: (p) =>
      setOngoing((prev) => [{ ...p, id: uid(), createdAt: new Date().toISOString() }, ...prev]),
    updateOngoing: (id, p) =>
